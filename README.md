...
**Experimental nets** — *for curiosity, not strength* (AVX2 only): **EP36-ABSURD** (wild, materially-reckless play) and **EP417-EXTREME** (purposeful and determined play). Expect weaker and stranger chess than the Elo/EAS builds above.
